...
\recipe{%
	...
	ingredients = {
        ...
        \ingredient{1 1/2 \tbl honey}
        \ingredient{1 1/2 \tbl sherry vinegar}
...
\recipe{%
	...
	serves = {12},
	ingredients = {
	    \ingredient{8 \cu (1/2-inch) cubed sourdough bread (about 12 ounces)}
        ...
        \ingredient{2 \cu (1/2-inch) cubed peeled Bartlett pear (about 2 medium)}
        \ingredient{1 1/2 \tbl chopped fresh basil}
        \ingredient{2 \tsp chopped fresh tarragon}
        \ingredient{1 \tsp salt}
        \ingredient{1 1/2 \cu fat-free, less-sodium chicken broth}
        \ingredient{1/2 \tsp freshly ground black pepper}
...
\recipe{%
	...
	extrainstructioninfo = {Place additional comments here.},
	ingredients = {
	    \ingredient{⅓ \cu (1 1/2 ounces) grated fresh Parmesan cheese, divided}
	    ...
	    \ingredient{⅓ \cu (1 ½ ounces) shredded provolone cheese}
		\ingredient{orzo}
		\ingredient(broccoli)
...
\recipe{%
	...
	ingredients = {
	    ...
	    \ingredient{⅛ \tsp ground red pepper}
...
\recipe{%
	...
	ingredients = {
	    ...
	    \ingredient{1 1/2 \tsp salt, divided}
	    \ingredient{1/2 \tsp freshly ground black pepper, divided}
...
\recipe{%
	...
	ingredients = {
        ...
        \ingredient{1 1/2 \tsp ground turmeric}
