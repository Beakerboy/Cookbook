...
\recipe{%
	...
	ingredients = {
	    ...
	    \ingredient{2 1/4 \cu four, about 307g}
		\ingredient{2 \tsp baking powder}
		\ingredient{1/2 \tsp baking soda}
		\ingredient{1 \tsp salt}
		\ingredient{12 \tbl cold butter}
		\ingredient{1 \cu buttermilk}

		\ingredientsection{Gravy}
		\instruction{1/2 pound sausage}
		\instruction{1 1/2 \cu whole milk}
		\instruction{1/6 \cu flour}
