...
\recipe{%
	...
	ingredients = {
			...
			\ingredient{2 large potatoes, peeled and chopped (2 ½ \cup)}
...
\recipe{%
	...
	ingredients = {
			...
			\ingredient{4 ears fresh corn (about 3 \cup) or 2 cans}
...
\recipe{%
	...
	ingredients = {
		...
		\ingredient{⅓ \cup diced red onion}
		\ingredient{⅓ \cup red wine vinegar}
		\ingredient{1 \tsp salt}
		\ingredient{2 \cup seedless red grapes, halved}
...
\recipe{%
	...
	ingredients = {
	    ...
	    \ingredient{1 ½ \cup bottled fat-free tomato-basil pasta sauce (such as Muir Glen Organic)}
	    \ingredient{2 teaspoons balsamic vinegar}
	    \ingredient{¼ teaspoon black pepper}
	    \ingredient{⅓ \cup (1 ½ ounces) shredded provolone cheese}
		\ingredient{orzo}
		\ingredient(broccoli)
