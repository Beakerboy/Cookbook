...
\RenewDocumentCommand{\ingredient@formatmulti}{m m m m}{%
    \def\ingredient@name{Butter}
    \def\ingredient@qty{#2}\trim@spaces@in\ingredient@qty%
    \def\ingredient@unit{Large}
    \def\ingredient@note{cracked}

    \def\ingredient@colB{}%
    \ifdefempty{\ingredient@unit}{}{\def\ingredient@colB{\ingredient@unit}}%
    \ifdefempty{\ingredient@colB}{\def\ingredient@colB{\ingredient@name}}{%
      \def\ingredient@colB{\ingredient@colB\space\ingredient@name}}%
    \ifdefempty{\ingredient@note}{}{%
      \def\ingredient@colB{\ingredient@colB,\ \ingredient@note}}%
