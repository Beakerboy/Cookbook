...
\makebackcoverpage{
	...
	bottomcontent={
		...
		When it comes to main courses, our \textbf{Gnocchi Bolognese} has been a inner tradition for decades, while the \textbf{Cider Brined Turkey} brings elegance to any Thanksgiving meal. And don't miss our family's favorite rice dish, Alton Brown's \textbf{Rice Pilaf} that is easy and quick to make.\newline\newline
