...
\recipe{%
	...
	ingredients = {
	    \ingredient{(16-ounce) package sage sausage}{1}
		\ingredient{(1½-ounce) slices sourdough bread, cut into ½-inch cubes (about 8 cups)}{8}
		\ingredient{\cu (about 2½ ounces) shredded sharp cheddar cheese}{⅔}
		\ingredient{\cu 1\% low-fat milk, divided}{3}
		\ingredient{\cu egg substitute}{1}
		\ingredient{\tbl Dijon mustard}{1}
		\ingredient{(10.75-ounce) can condensed 30\% reduced-sodium, 98\% fat-free cream of mushroom soup, undiluted}{1}
		},
	instructions = {
...
\recipe{%
	...
	ingredients = {
			...
			\ingredient{cooked ham}{8}{ounces}{coarsely chopped}
			\ingredient{eggs}{5}{}{lightly beaten}
			\ingredient{salt}{¼}{\tsp}
			\ingredient{ground black pepper}{⅛}{\tsp}
			\ingredient{shredded cheddar cheese (1 oz.)}{¼}{\cu}
		},
	instructions ={
...
\recipe{%
	...
	ingredients = {
		...
		\ingredient{lb. fresh broccoli}{1}{}{}
...
\recipe{%
	...
	extrainstructioninfo = {Place additional comments here.},
	ingredients = {
	    \ingredient{\cu long grain rice}{2}{}{}
	    \ingredient{\tbl oil}{2}{}{}
	    \ingredient{oz. tomato sauce}{8}{}{}
	    \ingredient{stems cilantro}{6}{}{}
	    \ingredient{\tsp salt}{1}{}{}
	    \ingredient{\tsp minced garlic}{1}{}{}
	    \ingredient{\cu water}{4}{}{}
	    \ingredient{cube chicken flavored bouillon}{1}{}{}
