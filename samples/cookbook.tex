...
\recipe{%
	...
	ingredients = {
	    ...
	    \ingredient{\tsp kosher salt}[1][]
	    \ingredient{\tsp crushed red pepper}[½][]
	    \ingredient{(28-ounce) can no-salt-added crushed tomatoes}[1][][undrained]
	    \ingredient{\cu no-salt-added tomato sauce}[1][]
	    \ingredient{\tbl chopped fresh oregano}[1][]
	    \ingredient{ounces uncooked mafaldine pasta}[16][]
	    \ingredient{½ \cu torn fresh basil}[][]
	    \ingredient{ounces shaved fresh Parmigiano-Reggiano cheese}[3][]
	},
	instructions = {
