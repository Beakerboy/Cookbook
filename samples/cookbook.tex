...
\RenewDocumentCommand{\ingredient@formatmulti}{m m m m}{%
    ...
    {\textit{\small
        ...
        \ifdefempty{\ingredient@colB}{\edef\ingredient@colB{\ingredient@name}}{\edef\ingredient@colB{\ingredient@colB\space\ingredient@name}}
...
\RenewDocumentCommand{\ingredient}{m O{} O{} O{}}{
	...
	\fi%
	\item
	% Check if this is old format (only first argument) or new format
	\ifblank{#4}{%
		\ifblank{#3}{%
			\ifblank{#2}{%
				...
				% #2 provided, use new format
				\ingredient@formatmulti{#1}{#2}{}{}%
			}%
		}{%
			% #3 provided, use new format
			\ingredient@formatmulti{#1}{#2}{#3}{}%
		}%
	}{%
		% #4 provided, use new format
