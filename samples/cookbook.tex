...
\RenewDocumentCommand{\ingredient@formatmulti}{m m m m}{%
    \def\ingredient@name{Eggs}\trim@spaces@in\ingredient@name%
    \def\ingredient@qty{4}\trim@spaces@in\ingredient@qty%
    \def\ingredient@unit{Large}\trim@spaces@in\ingredient@unit%
    \def\ingredient@note{cracked}\trim@spaces@in\ingredient@note%

    \def\ingredient@colB{}%
    \ifdefempty{\ingredient@unit}{}{\edef\ingredient@colB{\ingredient@unit}}%
    \ifdefempty{\ingredient@colB}{\edef\ingredient@colB{\ingredient@name}}{%
      \edef\ingredient@colB{\ingredient@colB\space\ingredient@name}}%
    \ifdefempty{\ingredient@note}{}{%
      \edef\ingredient@colB{\ingredient@colB, \ingredient@note}}%
...
\recipe{%
  ...
  \ingredient{Butter}[4][tbsp][melted]
	},
	instructions = {
